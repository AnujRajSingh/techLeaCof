 ...
 */
public class QWERTZKeyboardLayout implements KeyboardLayout
{
  private static final String NAME = "QWERTZ";
  ...
  static
  {
    ...
    pcKeyboard.put('z', new KeyboardLocation(6, 1, 9));
    ...
    pcKeyboard.put('#', new KeyboardLocation(12, 2, 15));

    pcKeyboard.put('<', new KeyboardLocation(1, 3, 16));
    pcKeyboard.put('y', new KeyboardLocation(2, 3, 15));
    pcKeyboard.put('x', new KeyboardLocation(3, 3, 14));
    pcKeyboard.put('c', new KeyboardLocation(4, 3, 13));
    pcKeyboard.put('v', new KeyboardLocation(5, 3, 12));
    pcKeyboard.put('b', new KeyboardLocation(6, 3, 11));
    pcKeyboard.put('n', new KeyboardLocation(7, 3, 11));
    pcKeyboard.put('m', new KeyboardLocation(8, 3, 12));
    pcKeyboard.put(',', new KeyboardLocation(9, 3, 13));
    pcKeyboard.put('.', new KeyboardLocation(10, 3, 14));
    pcKeyboard.put('-', new KeyboardLocation(11, 3, 15));

    // Shifted chars
    pcKeyboard.put('!', pcKeyboard.get('1'));
    pcKeyboard.put('"', pcKeyboard.get('2'));
    pcKeyboard.put('�', pcKeyboard.get('3'));
    pcKeyboard.put('$', pcKeyboard.get('4'));
    pcKeyboard.put('%', pcKeyboard.get('5'));
    pcKeyboard.put('&', pcKeyboard.get('6'));
    pcKeyboard.put('/', pcKeyboard.get('7'));
    pcKeyboard.put('{', pcKeyboard.get('7'));
    pcKeyboard.put('(', pcKeyboard.get('8'));
    pcKeyboard.put('[', pcKeyboard.get('8'));
    pcKeyboard.put(')', pcKeyboard.get('9'));
    pcKeyboard.put(']', pcKeyboard.get('9'));
    pcKeyboard.put('=', pcKeyboard.get('0'));
    pcKeyboard.put('}', pcKeyboard.get('0'));
    pcKeyboard.put('?', pcKeyboard.get('�'));
    pcKeyboard.put('\\', pcKeyboard.get('�'));

    pcKeyboard.put('@', pcKeyboard.get('q'));
    pcKeyboard.put('*', pcKeyboard.get('+'));
    pcKeyboard.put('~', pcKeyboard.get('+'));
    ...
    pcKeyboard.put('>', pcKeyboard.get('<'));
    pcKeyboard.put('|', pcKeyboard.get('<'));
    pcKeyboard.put('�', pcKeyboard.get('m'));
    pcKeyboard.put(';', pcKeyboard.get(','));
    pcKeyboard.put(':', pcKeyboard.get('.'));
    pcKeyboard.put('_', pcKeyboard.get('-'));

    // Alternate keys (ie. accented, etc.)
    pcKeyboard.put('�', pcKeyboard.get('a'));
    pcKeyboard.put('�', pcKeyboard.get('a'));
    pcKeyboard.put('�', pcKeyboard.get('a'));
    pcKeyboard.put('�', pcKeyboard.get('a'));
    pcKeyboard.put('�', pcKeyboard.get('e'));
    pcKeyboard.put('�', pcKeyboard.get('e'));
    pcKeyboard.put('�', pcKeyboard.get('e'));
    pcKeyboard.put('�', pcKeyboard.get('e'));
    pcKeyboard.put('�', pcKeyboard.get('i'));
    pcKeyboard.put('�', pcKeyboard.get('i'));
    pcKeyboard.put('�', pcKeyboard.get('i'));
    pcKeyboard.put('�', pcKeyboard.get('i'));
    pcKeyboard.put('�', pcKeyboard.get('o'));
    pcKeyboard.put('�', pcKeyboard.get('o'));
    pcKeyboard.put('�', pcKeyboard.get('o'));
    pcKeyboard.put('�', pcKeyboard.get('o'));
    pcKeyboard.put('�', pcKeyboard.get('u'));
    pcKeyboard.put('�', pcKeyboard.get('u'));
    pcKeyboard.put('�', pcKeyboard.get('u'));
    pcKeyboard.put('�', pcKeyboard.get('�'));
  }
