...
public class AZERTYKeyboardLayout implements KeyboardLayout
{
  private static final String NAME = "AZERTY";
  ...
  static
  {
    ...
    pcKeyboard.put('_', new KeyboardLocation(8, 0, 11));
    ...
    pcKeyboard.put('a', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('�', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('�', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('�', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('�', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('�', new KeyboardLocation(1, 1, 14));
    pcKeyboard.put('z', new KeyboardLocation(2, 1, 13));
    pcKeyboard.put('e', new KeyboardLocation(3, 1, 12));
    pcKeyboard.put('�', new KeyboardLocation(3, 1, 12));
    pcKeyboard.put('�', new KeyboardLocation(3, 1, 12));
    ...
    pcKeyboard.put('�', new KeyboardLocation(7, 1, 9));
    pcKeyboard.put('�', new KeyboardLocation(7, 1, 9));
    pcKeyboard.put('�', new KeyboardLocation(7, 1, 9));
    pcKeyboard.put('i', new KeyboardLocation(8, 1, 10));
    pcKeyboard.put('�', new KeyboardLocation(8, 1, 10));
    pcKeyboard.put('�', new KeyboardLocation(8, 1, 10));
    pcKeyboard.put('�', new KeyboardLocation(8, 1, 10));
    pcKeyboard.put('�', new KeyboardLocation(8, 1, 10));
    pcKeyboard.put('o', new KeyboardLocation(9, 1, 11));
    pcKeyboard.put('�', new KeyboardLocation(9, 1, 11));
    pcKeyboard.put('�', new KeyboardLocation(9, 1, 11));
    pcKeyboard.put('�', new KeyboardLocation(9, 1, 11));
    pcKeyboard.put('�', new KeyboardLocation(9, 1, 11));
    pcKeyboard.put('�', new KeyboardLocation(9, 1, 11));
    ...
    pcKeyboard.put('q', new KeyboardLocation(1, 2, 15));
    ...
    pcKeyboard.put('m', new KeyboardLocation(10, 2, 13));
    ...
    pcKeyboard.put('>', new KeyboardLocation(1, 3, 16));
    pcKeyboard.put('w', new KeyboardLocation(2, 3, 15));
